      ...
      <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-4xl">
        ...
        <div>
          ...
          <div className="border rounded-lg p-4">
            <h3 className="text-lg font-bold text-gray-800 mb-2">Lowyer Review Details</h3>
            ...
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-600">Specialization: Corporate Low</p>
              <p className="text-sm text-gray-600">Certifications: JD Certificate.pdf</p>
              <p className="text-sm text-gray-600">Years of Experience: 10</p>
            </div>

            {/* Preferences */}
            <div className="mb-4">
              <h4 className="text-sm font-semibold text-gray-700 mb-1">Address (optional) </h4>
              <p className="text-sm text-gray-600">Business Address: 123 Legal Ave, Suite 200</p>
            </div>
